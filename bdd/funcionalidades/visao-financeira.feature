...
Funcionalidade: Visão Financeira
  Como usuário autenticado do Firmus
  Quero acompanhar indicadores financeiros
  Para tomar decisões sobre cobranças, recebimentos e operação

  Contexto:
    Dado que o usuário está autenticado no Firmus
    E acessou a área de Visão Financeira

  @planejado @fin
  Cenário: BDD-FIN-001 — Acesso à página
  ...
  @planejado @fin
  Cenário: BDD-FIN-002 — Cards financeiros
    Quando o usuário executa o fluxo principal da funcionalidade
    Então o sistema deve apresentar as informações esperadas de forma clara
    E a ação disponível deve conduzir para o destino correto quando aplicável
    E não deve haver placeholders, duplicações ou mensagens confusas
  ...
  @planejado @fin
  Cenário: BDD-FIN-003 — Formatação monetária
    Quando o usuário executa o fluxo principal da funcionalidade
    Então o sistema deve apresentar as informações esperadas de forma clara
    E a ação disponível deve conduzir para o destino correto quando aplicável
    E não deve haver placeholders, duplicações ou mensagens confusas
  ...
  @planejado @fin
  Cenário: BDD-FIN-004 — Valores inconsistentes
    Quando o usuário executa o fluxo principal da funcionalidade
    Então o sistema deve apresentar as informações esperadas de forma clara
    E a ação disponível deve conduzir para o destino correto quando aplicável
    E não deve haver placeholders, duplicações ou mensagens confusas
  ...
  @planejado @fin
  Cenário: BDD-FIN-005 — Estado vazio
  ...
  @planejado @fin
  Cenário: BDD-FIN-006 — Status financeiros
    Quando o usuário executa o fluxo principal da funcionalidade
    Então o sistema deve apresentar as informações esperadas de forma clara
    E a ação disponível deve conduzir para o destino correto quando aplicável
    E não deve haver placeholders, duplicações ou mensagens confusas
  ...
  @planejado @fin
  Cenário: BDD-FIN-007 — Filtros se disponíveis
    Quando o usuário executa o fluxo principal da funcionalidade
    Então o sistema deve apresentar as informações esperadas de forma clara
    E a ação disponível deve conduzir para o destino correto quando aplicável
    E não deve haver placeholders, duplicações ou mensagens confusas
  ...
  @planejado @fin
  Cenário: BDD-FIN-008 — Desktop mobile e refresh
